...
Route::prefix("/forum")->group(function() {
    ...
    Route::get("/delete/{id}", [ForumController::class, "destroy"])->middleware(["auth"]);
});
...
Route::prefix("/event")->group(function() {
    ...
    Route::get("/view/{user_id?}/{id}", [EventController::class, "show"]);
    Route::get("/delete/{id}", [EventController::class, "destroy"])->middleware(["auth"]);
});
